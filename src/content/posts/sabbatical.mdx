...
Then came StreamYard and the wider shifts across the industry. After the post-COVID wave, instead of jumping right back into the corporate grind, I decided to do something different: taking time off from the formal 9-to-5, learning to slow down, nomading across South East Asia, and figuring out what building with purpose actually looks like.
...
---
*Check out the interactive visual timeline of this journey at the [Timeline Page](/timeline).*
